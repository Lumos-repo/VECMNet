...
def get_args():
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='TAL+sr0.3_tau0.015_margin0.1_n0.0', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
    ...
    parser.add_argument("--alpha1", type=float, default=0.28)
    ...
    parser.add_argument('--tau1', default=0.1, help='The scaling parameter of evidence extractor.')
    ...
    parser.add_argument('--margin2', default=0.2, type=float,help='Rank loss margin.')
    parser.add_argument('--lr_update', default=20, type=int,help='Number of epochs to update the learning rate.')
    ...
    parser.add_argument("--root_dir", default="/root/autodl-tmp/RDE-main/2024-CVPR-RDE/datasets/RED_dataset/")
    ...
    parser.add_argument('--noise_schedule', choices=['linear', 'cosine'], default='cosine')
    parser.add_argument('--diffusion_lambda', type=float, default=0.1)
    parser.add_argument('--diffusion_weight', type=float, default=0.5)
